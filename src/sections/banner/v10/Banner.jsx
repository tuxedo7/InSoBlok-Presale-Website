  ...
  return (
    <BannerWrapper>
      <div className="row aurora">
        ...
        <div className="_container_1dji6_1">
          <h1 className="_title_13gaz_1 _title_1dji6_8">How to buy</h1>
          <p className="_subtitle_1dji6_12">
            Buying INSO with ETH, BNB, USDT
          </p>
          <div className="_box_cprls_1 _box_1dji6_19">
            <div className="_step-container_1dji6_30">
              <p className="_step-label_1dji6_36">Step 1 - Wallet Setup</p>
              <p className="_body-text_1dji6_43">
              ...
              <div className="_wallet-buttons_1dji6_50">
                <a
                  href="https://metamask.io/"
                  target="_blank"
                  type="button"
                  className="custom_btn _wallet-button_1dji6_50 custom_btn--default custom_btn--large"
                >
                  Download
                ...
                >
                  Download
                  <img src={ICON_TRUSTWALLEt} alt="Trust wallet" />
                </a>
              </div>
            </div>
            <div className="_step-container_1dji6_30">
              <p className="_step-label_1dji6_36">Step 2 - Purchase Process</p>
              <p className="_body-text_1dji6_43">
                Ready to invest? Simply pick your preferred currency on our
                site, input how many INSO tokens you'd like, and hit 'Buy Now'.
                A prompt will pop up from your wallet for transaction
                confirmation, where you’ll also see the gas fees.
                <br />
                <span className="_italics_1dji6_75">
                  Note: Purchasing with USDT may involve two approvals—one
                  to okay the contract and another for the actual payment.
                </span>
              </p>
              <div className="_purchase-img-container_1dji6_80">
                <img
                  src={Purchase_Process}
                  alt="Representation of token"
                  className="_purchase-img_1dji6_80"
                />
              </div>
            </div>
            <div className="_step-container_1dji6_30">
              <p className="_step-label_1dji6_36">Step 3 - Token Reception</p>
              <p className="_body-text_1dji6_43">
                Once our presale wraps up, you can collect your INSO tokens
              ...
              <img
                className="_token-reception-img_1dji6_111"
                src={Token_Reception}
                alt="3 Inso coin logos overlapping"
              />
            </div>
          </div>
        </div>
